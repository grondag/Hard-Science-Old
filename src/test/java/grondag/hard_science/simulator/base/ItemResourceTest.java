...
public class ItemResourceTest
{
    ...
    public void test()
    {
        ...
        ItemResource r1a = ItemResource.fromStack(i1.getDefaultInstance());
        ItemStack stack = i1.getDefaultInstance().copy();
        stack.setCount(32);
        ItemResource r1b = ItemResource.fromStack(stack);
        ...
        r1b = ItemResource.fromStack(stack);
        ...
        stack.setTagCompound(nbt);
        ItemResource r2a = ItemResource.fromStack(stack);
        ...
        stack = i2.getDefaultInstance().copy();
        stack.setTagCompound(nbt);
        ItemResource r2b = ItemResource.fromStack(stack);
        ...
        stack = i2.getDefaultInstance().copy();
        stack.setTagCompound(nbt);
        r2b = ItemResource.fromStack(stack);
