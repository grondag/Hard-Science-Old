...
public class NiceCookbook {
	...
	static{
		...
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][0] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][0];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][1] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][1];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][2] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][2];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][3] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][3];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][4] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][4];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][5] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][5];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][6] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][6];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][7] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][7];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][8] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][8];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][9] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][9];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][10] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][10];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][11] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][12];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][12] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][14];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][13] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][16];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][14] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][18];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][15] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][20];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][16] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][22];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][17] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][24];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][18] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][26];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][19] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][28];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][20] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][30];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][21] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][32];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][22] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][34];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][23] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][38];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][24] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][42];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][25] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][46];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][26] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][50];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][27] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][54];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][28] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][58];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][29] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][62];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][30] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][66];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][31] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][70];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][32] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][74];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][33] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][78];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][34] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][82];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][35] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][90];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][36] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][98];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][37] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][106];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][38] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][114];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][39] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][122];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][40] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][130];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][41] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][138];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][42] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][146];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][43] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][162];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][44] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][178];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][45] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][194];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][46] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][210];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][47] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][226];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][48] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][242];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][49] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][258];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][50] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][274];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][51] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][290];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][52] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][306];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][53] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][322];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][54] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][338];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][55] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][354];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][56] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][370];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][57] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][146];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][58] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][146];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][59] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][178];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][60] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][178];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][61] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][162];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][62] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][162];
		SIMPLE_JOIN_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][63] = CONNECTED_CORNER_TEXTURE_OFFSETS[Rotation.ROTATE_NONE.index][0];
