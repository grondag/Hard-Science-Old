...
public class NiceBlockOld extends Block implements INiceBlock {
	...
	public static final PropertyInteger PROP_ALTERNATE = PropertyInteger.create("alt", 0, 16);
	...
	public class CustomStateMapper extends DefaultStateMapper{
		...
		public Map putStateModelLocations(Block block)
		{
			...
			for(EnumStyle style : EnumStyle.values()){
				for(int d = 0 ; d <= style.maxDetailID; d++){
					IBlockState state = block.getDefaultState().withProperty(PROP_STYLE, style).withProperty(PROP_DETAILS, d);
