...
public abstract class AbstractLavaCell
{
    ...
    ******************************************************/
    ...
    public void changeFluidUnitsUnsafely(int deltaUnits)
    {
    ...
    public void setFluidUnitsUnsafely(int newUnits)
    {
        if(newUnits < 0)
        {
            if(Adversity.DEBUG_MODE)
    ...
    public boolean changeFluidUnitsSafely(int deltaUnits, int expectedPriorUnits)
    {
    ...
    public int fluidSurfaceY()
    {
        ...
        return getYFromCeilingLevel(this.fluidSurfaceLevel());
    }
