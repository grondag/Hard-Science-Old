...
public class Textures
{
     ...
     */
    public static final TexturePallette USE_BASE = ALL_TEXTURES.addTexturePallette("raw_durastone", 4, TextureScale.SINGLE, TextureLayout.SPLIT_X_8, true, LIGHTING_SHADED_ONLY, BlockRenderLayer.SOLID, TextureGroup.ALWAYS_HIDDEN);
    ...
    public static final TexturePallette BIGTEX_LAVA = ALL_TEXTURES.addTexturePallette("lava", 1, TextureScale.MEDIUM, TextureLayout.BIGTEX, false, LIGHTING_BOTH, BlockRenderLayer.SOLID, TextureGroup.HIDDEN_TILES);
    ...
    public static final TexturePallette BIGTEX_TEST1 = ALL_TEXTURES.addTexturePallette("bigtex", 4, TextureScale.TINY, TextureLayout.SPLIT_X_8, true, LIGHTING_BOTH, BlockRenderLayer.SOLID, TextureGroup.HIDDEN_TILES);
    public static final TexturePallette BIGTEX_TEST2 = ALL_TEXTURES.addTexturePallette("bigtex", 4, TextureScale.SMALL, TextureLayout.SPLIT_X_8, true, LIGHTING_BOTH, BlockRenderLayer.SOLID, TextureGroup.HIDDEN_TILES);
    public static final TexturePallette BIGTEX_TEST3 = ALL_TEXTURES.addTexturePallette("bigtex", 4, TextureScale.MEDIUM, TextureLayout.SPLIT_X_8, true, LIGHTING_BOTH, BlockRenderLayer.SOLID, TextureGroup.HIDDEN_TILES);
    public static final TexturePallette BIGTEX_TEST4 = ALL_TEXTURES.addTexturePallette("bigtex", 4, TextureScale.LARGE, TextureLayout.SPLIT_X_8, true, LIGHTING_BOTH, BlockRenderLayer.SOLID, TextureGroup.HIDDEN_TILES);
    public static final TexturePallette BIGTEX_TEST5 = ALL_TEXTURES.addTexturePallette("bigtex", 4, TextureScale.GIANT, TextureLayout.SPLIT_X_8, true, LIGHTING_BOTH, BlockRenderLayer.SOLID, TextureGroup.HIDDEN_TILES);

    public static final TexturePallette BIGTEX_TEST_SINGLE = ALL_TEXTURES.addTexturePallette("bigtex_single", 1, TextureScale.SMALL, TextureLayout.BIGTEX, false, LIGHTING_BOTH, BlockRenderLayer.SOLID, TextureGroup.HIDDEN_TILES);
