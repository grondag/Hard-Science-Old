...
*/
public abstract class SuperBlock extends Block implements IWailaProvider
{
   ...
   public ModelState getDefaultModelState()
   {
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
        ...
        return super.getActualState(state, worldIn, pos)
                .withProperty(SHADE_FLAGS, (int)this.getModelState(state, worldIn, pos).getRenderLayerShadedFlags());
    }
...
//   }
   ...
   {
       return ((IExtendedBlockState)state).withProperty(MODEL_STATE, getModelState(state, world, pos));
   }

   public ModelState getModelState(IBlockState state, IBlockAccess world, BlockPos pos)
   {
       return this.getDefaultModelState().refreshFromWorld(state, world, pos);
   }
   
   public int getOcclusionKey(IBlockState state, IBlockAccess world, BlockPos pos, EnumFacing side)
   {
       return ModModels.MODEL_DISPATCH.getOcclusionKey(this.getModelState(state, world, pos), side);
   }
   ...
   public List<AxisAlignedBB> getSelectionBoundingBoxes(World worldIn, BlockPos pos, IBlockState state)
   {
       ...
       else
       {
           ...
           for (AxisAlignedBB aabb : handler.getCollisionBoxes(state, worldIn, pos, this.getModelState(state, worldIn, pos)))
           {
