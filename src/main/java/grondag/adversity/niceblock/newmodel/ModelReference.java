...
public class ModelReference
{
    ...
    static {
        ...
        MASONRY_FACADE_FACE_SELECTORS[0] = BORDER_FACADE_FACE_SELECTORS[0];
        MASONRY_FACADE_FACE_SELECTORS[1] = BORDER_FACADE_FACE_SELECTORS[1];
        MASONRY_FACADE_FACE_SELECTORS[2] = BORDER_FACADE_FACE_SELECTORS[2];
        MASONRY_FACADE_FACE_SELECTORS[3] = BORDER_FACADE_FACE_SELECTORS[3];
        MASONRY_FACADE_FACE_SELECTORS[4] = BORDER_FACADE_FACE_SELECTORS[4];
        MASONRY_FACADE_FACE_SELECTORS[5] = BORDER_FACADE_FACE_SELECTORS[5];
        MASONRY_FACADE_FACE_SELECTORS[6] = BORDER_FACADE_FACE_SELECTORS[6];
        MASONRY_FACADE_FACE_SELECTORS[7] = BORDER_FACADE_FACE_SELECTORS[7];
        MASONRY_FACADE_FACE_SELECTORS[8] = BORDER_FACADE_FACE_SELECTORS[8];
        MASONRY_FACADE_FACE_SELECTORS[9] = BORDER_FACADE_FACE_SELECTORS[9];
        MASONRY_FACADE_FACE_SELECTORS[10] = BORDER_FACADE_FACE_SELECTORS[10];
        MASONRY_FACADE_FACE_SELECTORS[11] = BORDER_FACADE_FACE_SELECTORS[12];
        MASONRY_FACADE_FACE_SELECTORS[12] = BORDER_FACADE_FACE_SELECTORS[14];
        MASONRY_FACADE_FACE_SELECTORS[13] = BORDER_FACADE_FACE_SELECTORS[16];
        MASONRY_FACADE_FACE_SELECTORS[14] = BORDER_FACADE_FACE_SELECTORS[18];
        MASONRY_FACADE_FACE_SELECTORS[15] = BORDER_FACADE_FACE_SELECTORS[20];
        MASONRY_FACADE_FACE_SELECTORS[16] = BORDER_FACADE_FACE_SELECTORS[22];
        MASONRY_FACADE_FACE_SELECTORS[17] = BORDER_FACADE_FACE_SELECTORS[24];
        MASONRY_FACADE_FACE_SELECTORS[18] = BORDER_FACADE_FACE_SELECTORS[26];
        MASONRY_FACADE_FACE_SELECTORS[19] = BORDER_FACADE_FACE_SELECTORS[28];
        MASONRY_FACADE_FACE_SELECTORS[20] = BORDER_FACADE_FACE_SELECTORS[30];
        MASONRY_FACADE_FACE_SELECTORS[21] = BORDER_FACADE_FACE_SELECTORS[32];
        MASONRY_FACADE_FACE_SELECTORS[22] = BORDER_FACADE_FACE_SELECTORS[34];
        MASONRY_FACADE_FACE_SELECTORS[23] = BORDER_FACADE_FACE_SELECTORS[38];
        MASONRY_FACADE_FACE_SELECTORS[24] = BORDER_FACADE_FACE_SELECTORS[42];
        MASONRY_FACADE_FACE_SELECTORS[25] = BORDER_FACADE_FACE_SELECTORS[46];
        MASONRY_FACADE_FACE_SELECTORS[26] = BORDER_FACADE_FACE_SELECTORS[50];
        MASONRY_FACADE_FACE_SELECTORS[27] = BORDER_FACADE_FACE_SELECTORS[54];
        MASONRY_FACADE_FACE_SELECTORS[28] = BORDER_FACADE_FACE_SELECTORS[58];
        MASONRY_FACADE_FACE_SELECTORS[29] = BORDER_FACADE_FACE_SELECTORS[62];
        MASONRY_FACADE_FACE_SELECTORS[30] = BORDER_FACADE_FACE_SELECTORS[66];
        MASONRY_FACADE_FACE_SELECTORS[31] = BORDER_FACADE_FACE_SELECTORS[70];
        MASONRY_FACADE_FACE_SELECTORS[32] = BORDER_FACADE_FACE_SELECTORS[74];
        MASONRY_FACADE_FACE_SELECTORS[33] = BORDER_FACADE_FACE_SELECTORS[78];
        MASONRY_FACADE_FACE_SELECTORS[34] = BORDER_FACADE_FACE_SELECTORS[82];
        MASONRY_FACADE_FACE_SELECTORS[35] = BORDER_FACADE_FACE_SELECTORS[90];
        MASONRY_FACADE_FACE_SELECTORS[36] = BORDER_FACADE_FACE_SELECTORS[98];
        MASONRY_FACADE_FACE_SELECTORS[37] = BORDER_FACADE_FACE_SELECTORS[106];
        MASONRY_FACADE_FACE_SELECTORS[38] = BORDER_FACADE_FACE_SELECTORS[114];
        MASONRY_FACADE_FACE_SELECTORS[39] = BORDER_FACADE_FACE_SELECTORS[122];
        MASONRY_FACADE_FACE_SELECTORS[40] = BORDER_FACADE_FACE_SELECTORS[130];
        MASONRY_FACADE_FACE_SELECTORS[41] = BORDER_FACADE_FACE_SELECTORS[138];
        MASONRY_FACADE_FACE_SELECTORS[42] = BORDER_FACADE_FACE_SELECTORS[146];
        MASONRY_FACADE_FACE_SELECTORS[43] = BORDER_FACADE_FACE_SELECTORS[162];
        MASONRY_FACADE_FACE_SELECTORS[44] = BORDER_FACADE_FACE_SELECTORS[178];
        MASONRY_FACADE_FACE_SELECTORS[45] = BORDER_FACADE_FACE_SELECTORS[194];
        MASONRY_FACADE_FACE_SELECTORS[46] = BORDER_FACADE_FACE_SELECTORS[210];
        MASONRY_FACADE_FACE_SELECTORS[47] = BORDER_FACADE_FACE_SELECTORS[226];
        MASONRY_FACADE_FACE_SELECTORS[48] = BORDER_FACADE_FACE_SELECTORS[242];
        MASONRY_FACADE_FACE_SELECTORS[49] = BORDER_FACADE_FACE_SELECTORS[258];
        MASONRY_FACADE_FACE_SELECTORS[50] = BORDER_FACADE_FACE_SELECTORS[274];
        MASONRY_FACADE_FACE_SELECTORS[51] = BORDER_FACADE_FACE_SELECTORS[290];
        MASONRY_FACADE_FACE_SELECTORS[52] = BORDER_FACADE_FACE_SELECTORS[306];
        MASONRY_FACADE_FACE_SELECTORS[53] = BORDER_FACADE_FACE_SELECTORS[322];
        MASONRY_FACADE_FACE_SELECTORS[54] = BORDER_FACADE_FACE_SELECTORS[338];
        MASONRY_FACADE_FACE_SELECTORS[55] = BORDER_FACADE_FACE_SELECTORS[354];
        MASONRY_FACADE_FACE_SELECTORS[56] = BORDER_FACADE_FACE_SELECTORS[370];
        MASONRY_FACADE_FACE_SELECTORS[57] = BORDER_FACADE_FACE_SELECTORS[146];
        MASONRY_FACADE_FACE_SELECTORS[58] = BORDER_FACADE_FACE_SELECTORS[146];
        MASONRY_FACADE_FACE_SELECTORS[59] = BORDER_FACADE_FACE_SELECTORS[178];
        MASONRY_FACADE_FACE_SELECTORS[60] = BORDER_FACADE_FACE_SELECTORS[178];
        MASONRY_FACADE_FACE_SELECTORS[61] = BORDER_FACADE_FACE_SELECTORS[162];
        MASONRY_FACADE_FACE_SELECTORS[62] = BORDER_FACADE_FACE_SELECTORS[162];
        MASONRY_FACADE_FACE_SELECTORS[63] = BORDER_FACADE_FACE_SELECTORS[0];
        
        // masonry only has 16 face possibilities, with the last one indicating no face
        // 32 means no face for border faces
        for (FacadeFaceSelector fs : MASONRY_FACADE_FACE_SELECTORS)
        {
            for( int i = 0; i < 6; i++)
            {
