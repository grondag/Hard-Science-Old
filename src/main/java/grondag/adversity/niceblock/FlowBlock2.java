...
public abstract class FlowBlock2 extends NiceBlock implements IFlowBlock
{
    
    protected int tickRate = 20;
    
    public FlowBlock2(FlowHeightHelper blockModelHelper, BaseMaterial material, String styleName)
    {
