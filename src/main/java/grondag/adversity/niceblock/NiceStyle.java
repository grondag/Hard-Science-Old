...
public enum NiceStyle {
	RAW("", 0, 1, 4, true, new ModelCookbook(), NiceModel.class, NiceBlock.LAYER_SOLID),
	SMOOTH("", 4, 1, 4, true, new ModelCookbook(), NiceModel.class, NiceBlock.LAYER_SOLID),
	LARGE_BRICKS("", 96, 6, 4, true, new ModelCookbook(), NiceModel.class, NiceBlock.LAYER_SOLID),
	SMALL_BRICKS("", 120, 6, 4, true, new ModelCookbook(), NiceModel.class, NiceBlock.LAYER_SOLID),
	BIG_WORN("", 256, 48, 3, true, new ModelCookbookConnectedCorners(), NiceModel.class, NiceBlock.LAYER_SOLID),
	BIG_WEATHERED("", 400, 48, 1, true, new ModelCookbookConnectedCorners(), NiceModel.class, NiceBlock.LAYER_SOLID),
	BIG_ORNATE("", 448, 48, 1, true, new ModelCookbookConnectedCorners(), NiceModel.class, NiceBlock.LAYER_SOLID),
	MASONRY_A("", 16, 16, 1, true, new ModelCookbookMasonry(), NiceModel.class, NiceBlock.LAYER_SOLID),
	MASONRY_B("", 32, 16, 1, true, new ModelCookbookMasonry(), NiceModel.class, NiceBlock.LAYER_SOLID),
	MASONRY_C("", 48, 16, 1, true, new ModelCookbookMasonry(), NiceModel.class, NiceBlock.LAYER_SOLID),
	MASONRY_D("", 64, 16, 1, true, new ModelCookbookMasonry(), NiceModel.class, NiceBlock.LAYER_SOLID),
	MASONRY_E("", 80, 16, 1, true, new ModelCookbookMasonry(), NiceModel.class, NiceBlock.LAYER_SOLID),
	COLUMN_SQUARE_X("", 8, 9, 1, false, new ModelCookbookColumnSquare(Axis.X), NiceModel.class, NiceBlock.LAYER_CUTOUT),
	COLUMN_SQUARE_Y("", 8, 9, 1, false, new ModelCookbookColumnSquare(Axis.Y), NiceModel.class, NiceBlock.LAYER_CUTOUT),
	COLUMN_SQUARE_Z("", 8, 9, 1, false, new ModelCookbookColumnSquare(Axis.Z), NiceModel.class, NiceBlock.LAYER_CUTOUT),
	COLUMN_ROUND_X("", 4, 1, 1, false, new ModelCookbookColumnRound(Axis.X), NiceModel.class, NiceBlock.LAYER_CUTOUT),
	COLUMN_ROUND_Y("", 4, 1, 1, false, new ModelCookbookColumnRound(Axis.Y), NiceModel.class, NiceBlock.LAYER_CUTOUT),
	COLUMN_ROUND_Z("", 4, 1, 1, false, new ModelCookbookColumnRound(Axis.Z), NiceModel.class, NiceBlock.LAYER_CUTOUT);
	...
	NiceStyle(String textureSuffix, int textureIndex, int textureCount, int alternateCount,
			boolean useRotationsAsAlternates, ModelCookbook cookbook, Class<?> modelClass, int renderLayerFlags) {
