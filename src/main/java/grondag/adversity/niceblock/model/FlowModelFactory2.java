...
public class FlowModelFactory2 extends ModelFactory<ModelFactory.ModelInputs> implements ICollisionHandler
{
    ...
    public FlowModelFactory2(ModelInputs modelInputs, boolean enableCollision, ModelStateComponent<?,?>... components) 
    {
...
//        template.rotation = state.getValue(this.rotationComponent);
        ...
        int flowTex = state.getValue(this.flowTexComponent);
        template.minU = ((flowTex >> 3) & 7) * 2;
        template.maxU = template.minU + 2;
        
        template.minV = ((flowTex) & 7) * 2;
