 ...
 */
public abstract class ModelController2
{
    /**
     * MUST BE SET IN INITIALIZER!
     */
    protected ModelFactory2 bakedModelFactory;
    ...
    protected ModelController2(String textureName, int alternateTextureCount, BlockRenderLayer renderLayer, boolean isShaded,
    ...
    public ModelFactory2 getBakedModelFactory()
    {
