...
public class PortDescription<T extends StorageType<T>> implements IPortDescription<T>
{
    ...
    private static final EnumElement<EnumStorageType> STORAGE_TYPE = PACKER.createEnumElement(EnumStorageType.class);
    private static final EnumElement<PortConnector> CONNECTOR = PACKER.createEnumElement(PortConnector.class);
    private static final EnumElement<PortFunction> FUNCTION = PACKER.createEnumElement(PortFunction.class);
    private static final EnumElement<CarrierLevel> LEVEL = PACKER.createEnumElement(CarrierLevel.class);
    private static final IntElement CHANNEL = PACKER.createIntElement(Channel.MIN_CHANNEL_VALUE, Channel.MAX_CHANNEL_VALUE);
