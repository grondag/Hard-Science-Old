...
public class SimpleProcurementTask<V extends StorageType<V>> extends ProcurementTask<V>
{
    ...
    {
        return Collections.singletonList(this.resource.withQuantity(this.allocatedQuantity));
    }

    @Override
    public List<AbstractResourceWithQuantity<V>> wipDemands()
    {
        return Collections.singletonList(this.resource.withQuantity(this.wipQuantity));
    }
