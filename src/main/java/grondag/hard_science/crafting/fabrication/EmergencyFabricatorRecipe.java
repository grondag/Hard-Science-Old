...
public class EmergencyFabricatorRecipe extends GenericRecipe
{
     ...
     */
    public static List<EmergencyFabricatorRecipe>allRecipes()
    {
        ImmutableList.Builder<EmergencyFabricatorRecipe> builder = ImmutableList.builder();
        for(Process p : fabs)
        {
    ...
    protected EmergencyFabricatorRecipe(AbstractCraftingProcess<?> process, Result result, int ticksDuration)
    {
    ...
    public static class Process extends AbstractSingleModelProcess<EmergencyFabricatorRecipe>
    {
        ...
        @Override
        protected EmergencyFabricatorRecipe makeRecipe(AbstractSingleModelProcess<EmergencyFabricatorRecipe> abstractSingleModelProcess, Result result,
                int ticksDuration)
        {
            return new EmergencyFabricatorRecipe(this, result, ticksDuration);
        }
