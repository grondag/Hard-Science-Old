...
//    
//    /**
//     * Identifies allowed transport connector pairings and the resulting 
//     * connections of each valid pairing.<p>
//     * 
//     * Called during init from proxy so that happens 
//     * after connection registration is fully complete.
//     */
//    public static void registerConnectionPairs() 
//    {
//        connectionMap.clear();
//
